 ...
 *
 * Note: Atm. only `redis` is available (see bottom of this file)
 * TODO: Introduce two different storages. One storage used for the URL-blocks (queues) and one to dump the fetched content.
 */
