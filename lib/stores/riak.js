...
Riak.prototype.put = function (space, key, value, meta, cb) {
  this.db.save(space, key, value, meta, cb);
};

Riak.prototype.get = function (space, key, meta, cb) {
  this.db.get(space, key, meta, cb);
};
